...
import { prenomsMS } from '@/datas/ecris-le-mot/prenoms'
...
const EcrisLeMot: FC = () => {
  ...
  const { lengthOptions, uppercase, customListTrue, niveauMots } = options
  ...
  useEffect(()=>{
    const liste = pickAListOfElements(prenomsMS, lengthOptions)
    setListeMots(liste)
  ...
  return (
    <MainStyle>
      ...
      <OptionsPanel onClickHandler={removeOptionsPanel}>
        <OptionsEcrisMots listeTotale={prenomsMS} />  
      </OptionsPanel>
      {
